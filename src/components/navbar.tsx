        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-6 py-4 space-y-3">
            ...
            {user ? (
              ...
              <button onClick={() => { setAuthModal({ open: true, tab: "login" }); setMobileOpen(false); }} className="block text-sm font-medium text-gray-600 hover:text-gray-900">Sign In</button>
            )}
